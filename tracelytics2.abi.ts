...
export interface TracelyticsAbi extends Contract {
	...
	editprocess  (data: { user: string, company: string, processId: string, inputDeltas: ProductQuantities, outputDeltas: ProductQuantities, timestamp: string, data: Array<any>, startTime: string, endTime: string, machine: string, status: string, description: string, version: string })                      : Promise<any>;
